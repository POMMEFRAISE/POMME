...
import http.ClientHttpTraceMessage;
	...
	public void onMessage(Message messageReçu) {
		try {
			if (messageReçu instanceof TextMessage) {
				...
				System.out.println("Message reçu : " + textMessage.hashCode()+ " : " + textMessage.getJMSMessageID());
				String messageLu = textMessage.getText();
				
				new ClientHttpTraceMessage(messageLu, textMessage.getJMSMessageID());
